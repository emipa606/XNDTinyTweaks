...
public static class Dialog_AdvancedGameConfig_DoWindowContents
{
    public static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions)
    {
        ...
        foreach (var codeInstruction in instructionList)
        {
            ...
            if (instruction.opcode == OpCodes.Ldstr && (string)instruction.operand == "MapStartSeasonDefault")
            {
                ...
                instruction.operand = AccessTools.Method(typeof(Dialog_AdvancedGameConfig_DoWindowContents),
