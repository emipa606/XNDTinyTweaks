...
public static class Alert_ColonistNeedsTend_NeedingColonists
{
    public static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions)
    {
        ...
        var getMedicalInfo = AccessTools.Property(typeof(Building_Bed), nameof(Building_Bed.Medical))
            .GetGetMethod();
        var allowIfMedicalInfo =
            AccessTools.Method(typeof(Alert_ColonistNeedsTend_NeedingColonists), nameof(allowIfMedical));
